...
public final class EntityGuildMaster extends EntityNPC {
   ...
   public boolean interact(EntityPlayer entityplayer) {
      ...
      if (!worldObj.loadedEntityList.isEmpty()) {
         ...
         {
            if (entity instanceof EntityReficulGuardian && entity.getDistanceSqToEntity(this) <= 2000)
            {
               flag = true;
            }

            if (entity instanceof EntityReficulMage && entity.getDistanceSqToEntity(this) <= 2000)
            {
               flag = true;
            }

            if (entity instanceof EntityReficulSoldier && entity.getDistanceSqToEntity(this) <= 2000)
            {
               flag = true;
            }
         }
